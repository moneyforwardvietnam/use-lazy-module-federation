...
exports.useLazyModuleFederation = void 0;
var react_1 = require("react");
var componentCache = new Map();
var useLazyModuleFederation = function (_a) {
    var url = _a.url, scope = _a.scope, module = _a.module;
    var key = "".concat(url, "-").concat(scope, "-").concat(module);
    var _b = (0, react_1.useState)(), Component = _b[0], setComponent = _b[1];
    var _c = useDynamicScript(url), ready = _c.ready, errorLoading = _c.errorLoading;
...
exports.useLazyModuleFederation = useLazyModuleFederation;
    ...
    return function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // @ts-ignore
                return [4 /*yield*/, __webpack_init_sharing__('default')]; // Initializes the share scope. This fills it with known provided modules from this build and all remotes
                case 1:
                    // @ts-ignore
